...
const follow = async (req, res) => {
  try {
    ...
    if (action == true) {
      ...
      const check_following = await findOne("followers", {
        profileId: userId,
        following: profileId,
      });
    
      const check_followed = await findOne("followers", {
        profileId,
        followers: userId,
      });
      ...
      const following = await insertNewDocument("followers", {
        profileId: userId,
        following: profileId,
      ...
      const followed = await insertNewDocument("followers", {
        profileId,
        followers: userId,
